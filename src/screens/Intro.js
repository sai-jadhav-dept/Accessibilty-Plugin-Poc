...
import { View, Text, StyleSheet, ScrollView, Pressable, Linking, Animated, Easing } from 'react-native';
...
import { useDynamicColors, AccessibleFilteredImage, useAccessibility, TTSService, AccessibleFilteredSvg } from '../accessibility';
                        ...
                        <View style={[styles.animationDemoContainer, { backgroundColor: colors.boxBackground }]}>
                            ...
                            <View style={styles.animationRow}>
                                ...
                                <Animated.View style={[styles.animatedBox, { transform: [{ translateX: slideX }], backgroundColor: '#FF3B30' }]}>
                                    <Text style={styles.boxLabel}>Slide</Text>
                                </Animated.View>
                            </View>
                        </View>
                        <CommonButton
